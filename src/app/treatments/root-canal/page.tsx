...
const benefits = [
  ...
  "Eliminate tooth pain permanently",
  "Prevent infection spread to other teeth",
  "Restore full tooth function",
  "Long-lasting results with proper care",
  "Virtually painless procedure with modern techniques",
  "Cost-effective solution compared to extraction",
  "Quick recovery time with minimal discomfort",
];

export default function RootCanalPage() {
  // Schema markup for Root Canal Treatment
  const treatmentSchema = {
    "@context": "https://schema.org",
    "@type": "MedicalProcedure",
    name: "Root Canal Treatment",
    alternateName: ["RCT", "Endodontic Treatment", "Root Canal Therapy"],
    description:
      "Advanced root canal treatment in Hinjewadi, Pune using modern techniques and technology for painless tooth preservation.",
    provider: {
    ...
    howPerformed:
      "Using advanced rotary instruments and digital apex locators for precise and comfortable treatment",
    followup:
      "Post-treatment checkup after one week and crown placement if required",
    expectedPrognosis: "90-95% success rate with proper care",
    cost: {
      "@type": "MonetaryAmount",
      currency: "INR",
      value: "3000",
      ...
      <div>
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-blue-800 mb-6">
            Root Canal Treatment in Hinjewadi, Pune | Painless RCT
          </h1>
          <p className="text-xl text-blue-600 max-w-3xl mx-auto mb-8">
            ...
            canal treatment in Hinjewadi, Pune. Expert endodontists, modern
            technology, and comfortable experience at Om Dental Clinic. Book
            your painless RCT appointment today! canal therapy. Modern
            techniques ensure a comfortable, effective treatment.
          </p>
          <button
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-blue-600">
                ...
                advanced techniques and effective local anesthesia. Most
                patients report feeling comfortable throughout the treatment.
              </p>
            </div>
            <div className="space-y-3">
              <h3 className="text-xl font-bold text-blue-700">
        ...
        >
          ...
          <p className="text-xl mb-8">
            Don&apos;t wait until it gets worse. Contact us today for expert
